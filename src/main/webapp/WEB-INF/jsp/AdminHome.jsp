...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="AdminHome" class="site_title"><img src="assets/images/logo.jpg" width="40px" height="40px" style="	border-radius: 50%;"> <span>Company Name</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="spreadsheet"><i class="fa fa-file-excel-o"></i> Google Sheets</a>
                  </li>
                  <li><a href="sendQrcode"><i class="fa fa-comments-o"></i> Share QrCode </a>
                  </li>
        ...
        <div class="right_col" role="main">
          ...
          <button class="btn btn-round btn-success clf" data-toggle="collapse" data-target="#collapseOne" onclick="showf()" >
              <i class="fa fa-folder-o pr-2" aria-hidden="true"></i>Create Event</button>
                             ...
                             <div class="card card-body ml-1" style="background: none;width:fit-content;">
                                 ...
                                 <form action="folderCreation" method="post">
                                     <div class="form-group row">
                                         <label for="inputPassword" class="col-sm-10 col-form-label">Event Name</label>
                                         <div class="col-sm-10">
    ...
    <form method="post" action="folder" class="btn btn-default fol" >
        ...
        <i class="fa fa-folder-open btn btn-round btn-primary"> <input type="submit" class="btn btn-primary inp" name="view" value=""></i>
    </form>
</div>
